	...
	<body>
		...
		<div class="container">
			<div class="formregister text-center">
				<h5 style="color:#4D2A86;font-weight:bold">Konfirmasi Security Code</h5><br><br>
				<form method="post" role="form">
					...
					<button name="confirm" class="signup">Selesai</button>
				</form>
			</div>
			</div>
		</div>
...
<?php
	if(isset($_POST['confirm'])) {
		...
		$confirm = $_POST['v1'].$_POST['v2'].$_POST['v3'].$_POST['v4'].$_POST['v5'].$_POST['v6'];
		
		if($confirm == $_SESSION['security']) {
			
			$sql = "INSERT INTO user (nama,ponsel,email,security) VALUES 
			('$_SESSION[nama]','$_SESSION[ponsel]','$_SESSION[email]','$_SESSION[security]')";
			...
			echo "<script>alert('Security Code yang Anda masukkan salah!');location='security-confirm'</script>";
		}
	}
?>